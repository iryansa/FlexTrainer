...
namespace FlexTrainer
{
    public partial class TrainerRegister : Form
    {
        Register prev;
        Form1 form1;
        public TrainerRegister(Register prev, Form1 form1)
        {
            InitializeComponent();
            this.prev = prev;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string expertise = textBox6.Text;

            if (string.IsNullOrEmpty(un) || string.IsNullOrEmpty(pass) || string.IsNullOrEmpty(name) || string.IsNullOrEmpty(email) || string.IsNullOrEmpty(qualification) || string.IsNullOrEmpty(expertise))
            {
            ...
            string query = "insert into users(username, name, email, password, typeuser, qualification, expertise) values ('" + un + "', '" + name + "', '" + email + "', '" + pass + "', 'trainer' , '" + qualification + "' , '" + expertise + "');";
